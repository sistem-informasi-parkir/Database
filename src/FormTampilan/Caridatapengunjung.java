 ...
 * @author IYAL
 */
public class Caridatapengunjung extends javax.swing.JFrame {

    /**
     * Creates new form Caridatapengunjung
     */
    public Caridatapengunjung() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Caridatapengunjung.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Caridatapengunjung().setVisible(true);
            }
        });
    }
